...
| Answer user and judge questions      | [FAQ.md](FAQ.md)                                   |
| Understand the system design         | [architecture.md](architecture.md)                 |
| Select a risk profile                | [RISK_PROFILES.md](RISK_PROFILES.md)               |
| Run tests or a backtest              | [testing.md](testing.md)                           |
| Review safety and incident response  | [SECURITY_AND_SAFETY.md](SECURITY_AND_SAFETY.md)   |
...
agent and should be read before any live workflow.
